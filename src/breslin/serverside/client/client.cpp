...
void Client::joinGame()
{
	...
	mShape = new Shape(mServer->mGame->getOpenIndex(),mServer->mGame,this,mServer->mGame->getOpenPoint(),new Vector3D(),new Vector3D(),mServer->mGame->mRoot,true,true,.66f,1,false); 
}
