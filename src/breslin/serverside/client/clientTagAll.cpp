...
void ClientTagAll::createShape()
{
	...
	mShape = new ShapeTagAll(mServer->mGame->getOpenIndex(),mServerTagAll->mGameTagAll,this,new Vector3D(),new Vector3D(),new Vector3D(),mServer->mGame->mRoot,true,true,.66f,1,false); 
